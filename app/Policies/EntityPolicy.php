...
class EntityPolicy
{
    ...
    {
        return $user->abilities()->contains('read_entity');
    }
    ...
    {
        return $user->abilities()->contains('create_entity');
    }
    ...
    {
        return $user->abilities()->contains('update_entity');
    }
    ...
    {
        return $user->abilities()->contains('delete_entity');
    }
