...
@section('body')
    <div>
        ...
        <p>
            ...
            However a Resource belonging to a User which indicates the Resource Owner.
        </p>
        ...
        <p>
            ...
            request. This object is also used to "build" the table at the start of the page using the Laravel Blade
        ...
        <p>
            ...
            retrieve the user for a give resource, i.e. <code class="myCode">$resource->user</code>. The $resource
