...
@section('body')
    <div>
        ...
        <p>
            The <code class="myCode">update</code> method in the <code class="myCode">ResourceController</code> will
        ...
        <div class="p-1 border rounded-md">
            <pre><code class="text-xs bg-gray-200 php"><x-controllers.resource.update/></code></pre>
        </div>
        ...
        <p>
            So, firstly, when ever a resource is touched in the database we need to specify which fields are mass
        ...
        <p>
            Also as outlined in the <a class="text-blue-500" href="/resources">Read</a> Resources page,
            a <code class="myCode">belongsToMany()</code> relationship allows me to retrieve the users for a given
            Resource using the dynamic property, <code class="myCode">$resource->users</code>. This relationship
            is defined in the <code class="myCode">public function users()</code> section below.
        </p>
        ...
        <p>
            ...
            <code class="myCode">/resources/views/actions/resource/update.blade.php</code> view will render the HTML
            of the page that you are currently viewing. The <code class="myCode">$resource</code> object will also be
