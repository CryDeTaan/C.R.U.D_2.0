...
@section('body')
    <div>
        ...
        <p>
            ...
            In this case though, I am only reading a single Resource. Meaning, Reading a resource is either reading all
        ...
        <p>
            ...
            of the Resource. With this the controller can easily obtain an instance of the resource through something
        ...
        <p>
            ...
            be seen by the way the function is declared,
            <code class="myCode">public function show(Resource $resource)</code>.
        </p>
        ...
        <p>
            ...
            <code class="myCode">return $this->belongsTo(user::class);</code> and although I am not using it in this
            view, should I change my mind it is as easy as <code class="myCode">$resource->user;</code>.
        </p>
