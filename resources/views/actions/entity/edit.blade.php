...
@section('body')
    <div>
        ...
        <p>
            The <code class="myCode">U</code> in C.R.U.D. is for updating resources in this case an Entity. Similarly to
            how I read resource, so is updating a resources that it is a two part process. First a view to with a form
            of sorts, more often than not, already complete withe the resource to be changed. And then secondly, the the
            form will be sent as as a PUT request which is the step which will update the resource.
        </p>
        ...
        <p>
            ...
            which will be used to update the Entity. This is not generally included in the Edit view, but I did it to
        ...
        <p>
            Take note of the parameter sent through, similar to showing an Entity resource, the parameter in the URI
            will be used in the controller to obtain the requested resource. The process of returning this view start by
        ...
        <p>
            The <code class="myCode">edit</code> method in the <code class="myCode">EntityController</code> will
        ...
        <div class="p-1 border rounded-md">
            <pre><code class="text-xs bg-gray-200 php"><x-controllers.entity.edit/></code></pre>
        </div>

        {{-- View Description --}}
        <div class="text-xl mb-4 mt-12"><span class="-ml-6 text-gray-700">#</span> View</div>
        <p>
            The controller's return statement(<code class="myCode">return view('actions.entity.edit',
                compact('entity'));</code>) returns the <code
                class="myCode">/resources/views/actions/entity/edit.blade.php</code>
