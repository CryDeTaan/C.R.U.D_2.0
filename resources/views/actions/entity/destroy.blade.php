...
@section('body')
    <div>
        ...
        <p>
            The <code class="myCode">D</code> in C.R.U.D. is for Destroying a resources. To destroy an Entity a form is
        ...
        <p>
            Generally there isn't a 'dedicate' view for when a resource like an Entity is deleted. A user will most
            probably be redirected to the <a class="text-blue-500" href="{{ url()->previous() }}">previous</a> page.
        </p>
