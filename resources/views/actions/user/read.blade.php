...
@section('body')
    <div>
        ...
        <p>
            ...
            In this page I am listing all the resources of a specific type and selecting a resource from the table
        ...
        <p>
            ...
            will handle this request. And although the resources in this request are still of type User, I want to
        ...
        <p>
            ...
            then make use of the Dynamic Property on the Model to retrieve all the users for the given role. Also notice
            that I am making use of <code class="myCode">request()->actionOn</code> to get the User type from the URL.
        </p>

        {{-- Controller Code Block --}}
        <x-controllers.user.index/>
        ...
        <p>
            ...
            In order to return the Users associated with a given role, the model has to be configured with a
        ...
        <p>
            ...
            should be authorised by the <code class="myCode">viewAny</code> Policy method as follows:
        </p>
        ...
        <p>
            The <code class="myCode">$users</code> object will contain only the users that have the
            {{ request()->actionOn }} role and can be seen below. This object is also used to "build" the table
            at the top of this page using the Laravel Blade Control Structure;
